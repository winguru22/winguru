<?php
	...
	//$data;
	$userid = $_SESSION['_id'];
	$sql = "SELECT FIRSTNAME, ACCOUNTNO from banks WHERE USER_ID=$userid";
   ...
   <body style="font-size: 36px;" data-new-gr-c-s-check-loaded="14.1017.0" data-gr-ext-installed="">
      ...
      <div data-v-be68bb7c="" class="bankcard">
         <nav data-v-be68bb7c="" class="top_nav">
            <div data-v-be68bb7c="" class="left"><a href="profile.php"><i class='fa fa-arrow-left fa-2x' style="margin-right:15px; color:white;" ></i></a><span data-v-be68bb7c="">Bank Card</span></div>
            <div data-v-be68bb7c="" class="right"><a href="bank.php"><i class='fa fa-plus fa-2x' style="margin-right:15px; color:white;" ></i></a></div>
         </nav>
         <div data-v-be68bb7c="" class="address_list">
            <ul data-v-be68bb7c="" class="list_ul">
			   ...
			   foreach($rows as $k => $v){
				   //print_r($v);
				   echo "<li data-v-be68bb7c=''>
							<ol data-v-be68bb7c='' class='left_icon'>
								<i class='fa fa-credit-card-alt fa-2x' ></i>
							</ol>
							<ol data-v-be68bb7c='' class='center'>
								<p data-v-be68bb7c='' class='name'>".$v['FIRSTNAME']."</p>
								<p data-v-be68bb7c='' class='info_text'>".$v['ACCOUNTNO']."</p>
							</ol>
							<ol data-v-be68bb7c='' class='right_icon'>
