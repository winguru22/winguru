<?php
	...
	//$data;
	$userid = $_SESSION['_id'];
	$sql = "SELECT FIRSTNAME, UPI_ID from upilist WHERE USER_ID=$userid";
   ...
   <body style="font-size: 36px;" data-new-gr-c-s-check-loaded="14.1017.0" data-gr-ext-installed="">
      ...
      <div data-v-be68bb7c="" class="bankcard">
         <nav data-v-be68bb7c="" class="top_nav">
            <div data-v-be68bb7c="" class="left"><a href="profile.php"><i class='fa fa-arrow-left fa-2x' style="margin-right:15px; color:white;" ></i></a><span data-v-be68bb7c="">UPI list</span></div>
            <div data-v-be68bb7c="" class="right"><a href="addupi.php"><i class='fa fa-plus fa-2x' style="margin-right:15px; color:white;" ></i></a></div>
         </nav>
			   ...
			   foreach($rows as $k => $v){
				   ...
				   echo "<li data-v-be68bb7c=''>
							...
							<ol data-v-be68bb7c='' class='center'>
								...
								<p data-v-be68bb7c='' class='info_text'>".$v['UPI_ID']."</p>
							</ol>
