   ...
   <body style="font-size: 24px;">
      ...
      <div data-v-d2db546c="" class="addbankcard">
         <nav data-v-d2db546c="" class="top_nav">
            <div data-v-d2db546c="" class="left"><a href="banklist.php"><i class='fa fa-arrow-left fa-2x' style="margin-right:15px; color:white;" ></i></a><span data-v-d2db546c="">Add Bank Card</span></div>
         </nav>
         <div class="main">
			<form action="#" id="myform" method="POST">
				...
				<input type="text" id="ifsccode" name="ifsccode" placeholder="Your IFSC Code.." required>
				
				<label for="bankname">Bank Name</label>
				<input type="text" id="bankname" name="bankname" placeholder="Your Bank Name.." required>
				
				<label for="bankaccount">Bank Account</label>
				<input type="text" id="accountno" name="accountno" placeholder="Your Bank Account.." required>
